...
describe('Cloud Mode RLS', () => {
  // RLS tests only run with PostgreSQL schema - skip if using local schema
  ...
  it('should deny user1 access to user2 conversation with RLS', async () => {
    ...
    // RLS should deny access - conversation should be null
  ...
  it('should deny user1 delete of user2 conversation', async () => {
    ...
    // Try to delete user2's conversation
    await expect(
  ...
  it('should deny user1 update of user2 conversation', async () => {
    ...
    // Try to update user2's conversation
    await expect(
